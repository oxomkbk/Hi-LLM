with expected as (
  select '{
    "skill": "skilltrustbench-t01-t09+priority-material+document-evidence-v3-platform-fallback",
    "mcp": "mcp-config+priority-source+document-evidence-v3-platform-fallback"
  }'::jsonb as rules
), changed as (
