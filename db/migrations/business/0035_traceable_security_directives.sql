with expected as (
  select '{
    "skill": "skilltrustbench-t01-t09+priority-material+document-evidence-v5-traceable-directives",
    "mcp": "mcp-config+priority-source+document-evidence-v5-traceable-directives"
  }'::jsonb as rules
), changed as (
