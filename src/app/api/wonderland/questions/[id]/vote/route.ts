...
import { setQuestionVote } from '@/lib/wonderland/services/community'
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return wonderlandSuccess(await setQuestionVote({ actor: session.user, questionId: id, value: body.value }))
  }
  catch (error) {
